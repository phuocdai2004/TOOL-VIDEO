...
VOICE_PREVIEW_TEXTS = {
    ...
    "vi": "Xin chào, tôi là {name}, đây là đoạn nghe thử giọng đọc.",
...
_FALLBACK_VOICES = [
    ...
    {"id": "vi-VN-HoaiMyNeural", "name": "HoaiMy", "local_name": "HoaiMy",
     "region": "vi-VN", "region_code": "vi-VN", "gender": "female",
     "style_tags": ["Warm"], "preview_text": "Xin chào, tôi là HoaiMy, đây là đoạn nghe thử giọng đọc.", "lang": "vi"},
    {"id": "vi-VN-NamMinhNeural", "name": "NamMinh", "local_name": "NamMinh",
     "region": "vi-VN", "region_code": "vi-VN", "gender": "male",
     "style_tags": ["Professional"], "preview_text": "Xin chào, tôi là NamMinh, đây là đoạn nghe thử giọng đọc.", "lang": "vi"},
]
...
def _build_fallback_catalog() -> dict:
    return {
        "languages": [
            {"code": "zh", "label": "中文", "count": len([v for v in _FALLBACK_VOICES if v["lang"] == "zh"]), "voices": [v for v in _FALLBACK_VOICES if v["lang"] == "zh"]},
            {"code": "vi", "label": "Tiếng Việt", "count": len([v for v in _FALLBACK_VOICES if v["lang"] == "vi"]), "voices": [v for v in _FALLBACK_VOICES if v["lang"] == "vi"]}
        ],
...
async def load_voice_catalog(force: bool = False) -> dict:
    ...
    # 保持设计文档约定的高频语言顺序
    _order = ["vi", "zh", "en", "ja", "ko", "ru", "es", "fr", "de", "nl", "pt", "it", "id", "ms"]
